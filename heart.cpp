...
//アニメのパターンを変える
//=============================================================================
void CHeart::ChangeTextureAnime( int nPatternAnim, D3DXVECTOR2 ptnSize, D3DXVECTOR2 ptnDivide)
{
	//頂点バッファの中身を埋める
	VERTEX_2D *pVtx;
...
//色を変更
//=============================================================================
void CHeart::SetColor(const D3DXCOLOR &col)
{
	// 頂点情報を設定
	VERTEX_2D *pVtx;
